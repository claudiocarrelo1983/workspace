    ...
    <div class="col mt-5 mb-2">
        <div class="row process my-5 justify-content-center">    
            ...
            <?php foreach($arrResultExist as $key => $value): ?>                
                <div class="<?= (($inc == $countSteps) ? 'process-step' : 'process-step') ?> col-4 mb-5 mb-lg-4 appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" style="animation-delay: 200ms;">
                    <div class="process-step-circle  process-step-circle-<?= (($type == $key) ? 'primary' : 'grey' ) ?>">
                        <strong class="process-step-circle-content pt-1">                           

                            <?=
                                Html::a(
                                    '<i class="'.$value['icon'].'  text-5 text-'.(($type == $key) ? 'primary' : 'grey' ).'"></i>',                                           
                                    Url::toRoute(
                                    array_merge(
                                            ['/'.$key, 'code' => Yii::$app->request->get('code')]                                           
                                        )
                                    ),
                                    [
...
<div class="row d-md-none ">
    <div class="col mt-5">
        <div class="row process  justify-content-center">    
            ...
            ?>
            <?php foreach($arrResultExist as $key => $value): ?>                
                <div class="<?= (($inc == $countSteps) ? 'process-step' : 'process-step') ?> col-4 mb-4 mb-lg-4 appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" style="animation-delay: 200ms;">
                    <div class="process-step-circle-<?= (($type == $key) ? 'primary' : 'grey' ) ?> text-center">
                    ...
                    <div class="process-step-content">
                        <h4 class="mb-1 text-3 font-weight-bold">
                            <?=  Yii::t('app', $key) ?>
                        </h4>            
                    </div>           
                </div>
