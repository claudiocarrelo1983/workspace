...
<div class="row">
    <!-- Start Services -->                               
        <?= $this->render('@frontend/views/client/team-booking/date',[
            'day' => date('d-m-Y',$day),
            'url' => $url,
            'username' => $username,
                        ...
                        <?php
                            ...
                            switch ($values['type']) {
                                ...
                                case 2:
                                    ...
                                    echo  $this->render('@frontend/views/client/team-booking/modals/schedule_modal_view', 
                                    [
                                        'model' => $modelEdit,  
                                        'url' => $url,  
                                        'coin' => $coin,                        
                                    ...
                                    echo    $this->render('@frontend/views/client/team-booking/modals/schedule_modal_confirm', 
                                    [
                                        'model' => $modelEdit,  
                                        'url' => $url,       
                                        'coin' => $coin,                     
                                    ...
                                    echo    $this->render('@frontend/views/client/team-booking/modals/schedule_modal_cancel', 
                                    [
                                        'model' => $modelEdit,  
                                        'url' => $url,  
                                        'coin' => $coin,                          
                                    ...
                                    echo    $this->render('@frontend/views/client/team-booking/modals/schedule_modal_missed', 
                                    [
                                        'model' => $modelEdit,   
                                        'url' => $url,   
                                        'coin' => $coin,                        
                                    ...
                                    echo $this->render('@frontend/views/client/team-booking/modals/schedule_modal_edit', 
                                    [
                                        'model' => $modelEdit,    
                                        'url' => $url,  
                                        'arrSheddule' => $arrSheddule,
                                        'coin' => $coin,                       
                                        'inc' => $inc,    
                                        'date' => $day,    
                                        'dayHour' => $dayHour,                      
                            ...
                            echo $this->render('@frontend/views/client/team-booking/modals/schedule_modal_create', 
                            [
                                'model' => $model,     
                                'url' => $url,  
                                'arrSheddule' => $arrSheddule, 
