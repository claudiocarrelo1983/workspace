...
<?php 
    ...
    $displayByDay = ((empty(Yii::$app->request->get('username'))) ? 'display:none' : $displayByDay);
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-8  text-left">
                                    <?= $formEdit->field($modelSheddule, 'service_code')->dropdownList(
                                        $arrServicesDropdown,
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">                                                                
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-8  text-left">
                                        <?= $formCreate->field($modelShedduleCreate, 'service_code')->dropdownList(
                                            $arrServicesDropdown,
                                            ['class' => 'form-select form-control h-auto py-2','prompt'=>'Select Service'])->label('Serviço')
                                        ?>                                                
                                    </div>
