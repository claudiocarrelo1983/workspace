                            ...
                            <?= 
                                Html::a(
                                    Html::img(
                                        ...
                                        ['class' => 'd-md-none img-fluid  img-thumbnail p-1 mt-3', 'style' => 'top: 5px;  height: 150px;']),                      
                            ...
                            <?= 
                                Html::a(
                                    Html::img(
                                        $companyArr['path'].$companyArr['image_logo'], 
                                        //['class' => 'img-fluid border img-thumbnail mt-2 ', 'style' => 'top: 0px;  ']),  
                                        ['class' => 'd-none d-sm-none d-md-block img-fluid  img-thumbnail p-1 mt-3', 'style' => 'top: 28px;  height: 150px;']),                      
                                    Url::toRoute(['/page', 'code' => $company])
                                ) 
                            ?>  				
                        </div>
                ...
                <div class="header-column justify-content-end">
                    <div class="header-row">
                        <div class="header-nav header-nav-line header-nav-bottom-line header-nav-bottom-line-no-transform header-nav-bottom-line-active-text-light header-nav-bottom-line-effect-1 header-nav-light-text order-2 order-lg-1">
                            <div class="header-nav-main header-padding header-nav-main-square header-nav-main-effect-2 header-nav-main-sub-effect-1  justify-content-end">
