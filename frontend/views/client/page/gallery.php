...
$arrImages = Helpers::arrayCompanyImages();


?>

<?php if(!empty($arrImages)){ ?>
    <section id="examples" class="section section-height-5 section-with-shape-divider border-0  lazyloaded" data-bg-src="img/parallax/parallax-2.jpg">
        <div class="shape-divider shape-divider-reverse-x" style="height: 243px;">
        ...
        <div class="container my-3"> 
            <div class="row align-items-center">
                ...
                <div class="col-md-8 col-md-center mx-auto appear-animation animated fadeInLeftShorter appear-animation-visible" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1000" style="animation-delay: 1000ms;">
                    <div class="owl-carousel owl-theme nav-inside mb-0 owl-loaded owl-drag owl-carousel-init" data-plugin-options="{'items': 1, 'margin': 10, 'animateOut': 'fadeOut', 'autoplay': true, 'autoplayTimeout': 6000, 'loop': true}" style="height: auto;">
                        <div class="owl-stage-outer">
                            <div class="owl-stage" style="transform: translate3d(-1112px, 0px, 0px); transition: all 0s ease 0s; width: 3336px;">
                                <?php foreach($arrImages as $value){ ?>
                                    <div class="owl-item active" style="width: 546px; margin-right: 10px;">
                                        <div>
                                            <img alt="<?= $value['alt'] ?>" class="img-fluid" src="<?= '/media/'.$value['company_code'].'/'.$value['path'].$value['image'] ?>">
                                        </div>
                                    </div>                     
                                <?php } ?>                  
                            </div>
        ...
        <div class="shape-divider shape-divider-bottom shape-divider-reverse-y" style="height: 243px;">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 2000 245" preserveAspectRatio="none">
                <path fill="#FFF" opacity="0.5" d="M2028.47,246.15v-39.09C1945.6,199.68,1869.96,195.8,1803,194c-71.99-1.93-137.53-4.37-225,1
                    c-88.04,5.4-120.19,13.36-233,19c-55.14,2.76-102.19,5-165,3c-37.5-1.2-102.55-4.6-200-19c-89.42-13.21-145.61-26.73-276-57
                    C520.19,98.33,428.29,76.99,402,72C243.75,41.93,118.41,28.67,37,22c-26.77-2.19-49.49-3.73-66.33-4.77v229.03h2057.82
