...
$menu = $modelGeneratorJson->getLastFileUploaded('other','public-menu');
$structure = $modelGeneratorJson->getLastFileUploaded('other','footer');
		...
		<div class="row py-5 my-4">
			...
			<div class="col-md-6 col-lg-3 mb-5 mb-lg-0 align-items-center">
				...
				<ul class="list list-unstyled mb-0">
					<?php 
						if(isset($menu['menu'])){
							foreach ($menu['menu'] as $menucategory): ?> 
			...
			<div class="col-md-6 col-lg-3 align-items-center">
				...
				<span class="form-style-5 opacity-10">
					<div class="row ">
						<?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data'], 'class' => 'contact-form-recaptcha-v3']) ?>    
							<div class="row">
								<div class="form-group col-lg-12">										          			
									<?= $form->field($modelFooter, 'email')->textInput(['class' => 'form-control text-3 h-auto py-2'])->label('') ?>                                                                                                            
								</div>
							</div> 
							<div class="form-group">
								<?= Html::submitButton(
									Yii::t('app', "footer_category_subscribe_button"),
