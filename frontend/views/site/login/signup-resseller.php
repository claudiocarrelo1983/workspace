            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center">
                    <h2 class="font-weight-bold text-9 mb-0">
                        <?= Yii::t('app', "signup_resseller_block_title_1") ?>
                    </h2>
                    <p class="text-1rem text-color-default negative-ls-05 pt-3 pb-4 mb-5">
                        <?= Yii::t('app', "signup_resseller_block_text_1") ?>           
                    </p>
                </div>   
                <div class="col-md-10 col-lg-10">           
                    ...
                    <?php $form = ActiveForm::begin(['id' => 'form-signup']); ?> 
                        ...
                        <div class="row">                         
                            ...
                            <div class="form-group col-lg-6">                        
                                <?= $form->field($modelSignupForm, 'voucher')->textInput(['class' => 'form-control text-3 h-auto py-2'])->label(Yii::t('app', "signup_block_voucher").':') ?>
                            </div> 
                        </div>                     
                        <div class="row">
