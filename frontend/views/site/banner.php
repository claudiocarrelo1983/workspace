    ...
    <div class="container pt-lg-5 mt-5">
        <div class="row pt-3 pb-lg-0 pb-xl-0">
            <div class="col-lg-6 pt-4 mb-5 mb-lg-0">
                ...
                <a href="<?= str_replace('/frontend/web', '',Url::toRoute('site/recipes')) ?>" data-hash="" data-hash-offset="0" data-hash-offset-lg="100" class="btn btn-gradient-primary btn-effect-4 font-weight-semi-bold px-4 btn-py-2 text-3">
                    <?php 
                    // Yii::t('app', 'breadcrumb_get_started_now') Url::toRoute('site/mobile-app')
                     echo Yii::t('app', 'menu_recipes');
                     ?>	
                </a>
                <a href="<?= str_replace('/frontend/web', '', Url::toRoute('site/blog')) ?>" class="btn btn-light btn-outline btn-outline-thin btn-outline-light-opacity-2 btn-effect-5 font-weight-semi-bold px-4 btn-py-2 text-3 text-color-light text-color-hover-dark ms-2" target="_blank">
                    <?php 
