            ...
            <div class="col-lg-6 pt-4 mb-5 mb-lg-0">
                ...
                <a href="<?= str_replace('/frontend/web', '',Url::toRoute(['site/checkout','plan' => 'basic'])) ?>" data-hash="" data-hash-offset="0" data-hash-offset-lg="100" class="btn btn-gradient-primary btn-effect-4 font-weight-semi-bold px-4 btn-py-2 text-3">
                    ...
                    // Yii::t('app', 'breadcrumb_get_started_now') Url::toRoute('site/mobile-app')
                     echo Yii::t('app', 'breadcrumb_start_free_trial');
                     ?>	
                </a>
                <a href="<?= str_replace('/frontend/web', '', Url::toRoute('site/pricing')) ?>" class="btn btn-light btn-outline btn-outline-thin btn-outline-light-opacity-2 btn-effect-5 font-weight-semi-bold px-4 btn-py-2 text-3 text-color-light text-color-hover-dark ms-2" target="_blank">
                    <?php 
                    //Yii::t('app', 'breadcrumb_pricing')  Url::toRoute('site/pricing') 
                        echo Yii::t('app', 'breadcrumb_compare_prices') 
                    ?>	
