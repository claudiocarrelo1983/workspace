...
$structure  = Recipes::recipesTags($structure);
...
<aside class="sidebar">
    ...
    <ul class="nav nav-list flex-column mb-5">
        <li class="nav-item">
            <a class="nav-link" href="<?= Url::toRoute(['site/recipes']); ?>">
            ...
            <li class="nav-item">
                ...
                ?>
                <a class="nav-link" onclick="recipesToogle(<?= $key ?>);" <?= $url ?>><?= Yii::t('app',$categories['tag']) ?> <?= (($count == 0) ? '' :  '('.$count.')') ?></a>  
