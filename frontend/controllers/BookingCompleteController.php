...
class BookingCompleteController extends Controller
{
       
    public function actionIndex($booking_code)
    {      
        ...
        $filter['booking_code'] = $booking_code;
        ...
        return $this->render('@frontend/views/client/booking/complete', [             
            'model' => $model, 
            'sheddule' => $sheddule,
