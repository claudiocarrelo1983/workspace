...
/**
 * ServicesCategorySearch represents the model behind the search form of `app\models\ServicesCategory`.
 */
class ServicesCategorySearch extends ServicesCategory
{
    /**
     * {@inheritdoc}
     */
