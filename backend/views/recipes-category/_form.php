...
foreach($tags as $tag){
    $arrTags[$tag['recipe_cat_code']] = $tag['description'];   
}
    ...
    <div class="tabs tabs-dark mb-4 pb-2">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="popularPosts">  
                ...
                <?= $form->field($model, 'recipes_parent_id')->dropdownList(
                    $arrTags,
            ...
            <?php 
                ...
                ?>  
                <?= $form->field($model, 'recipe_'.$value['country_code'])->textInput(['maxlength' => true])->label('Description '.$value['full_title']) ?>
            
            <?php 
                }else{
            ?>
                <?=  $form->field($model, 'recipe_'.$valLang)->hiddenInput(['value'=> 'n/a'])->label(false); ?>           
            <?php 
